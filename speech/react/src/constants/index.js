...
export const LOAD_AUDIO = 'speech/LOAD_AUDIO';
export const START_ANALYSIS = 'speech/START_ANALYSIS';
export const END_ANALYSIS = 'speech/END_ANALYSIS';
export const ERROR = 'speech/ERROR';
